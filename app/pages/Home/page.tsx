...
const HomeLayoutWrapper = dynamic(
  () => import("@/app/layouts/HomeLayoutWrapper"),
  { ssr: false }
);
        ...
        <div className="max-w-3xl animate-fade-in-up">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {post.tags?.map((tag, index) => (
              <span
                key={index}
                className="text-xs font-medium bg-white/10 backdrop-blur-sm text-white px-3 py-1 rounded-full border border-white/10"
              >
                {tag}
              </span>
            ))}
            <span className="text-xs font-medium bg-indigo-600/80 text-white px-3 py-1 rounded-full">
              Trending
            </span>
          </div>
  ...
  return (
    <HomeLayoutWrapper>
              ...
              <div className="w-full h-full relative flex flex-col justify-end">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  ...
                  >
                    ...
                    <span className="absolute mt-28 bg-black/80 backdrop-blur-sm px-4 py-2 rounded-full text-white opacity-0 group-hover:opacity-100 transition-opacity">
                      Play Now
                    </span>
                  </button>
                </div>
                  ...
                  <div className="max-w-6xl mx-auto p-6 sm:p-8 md:p-10">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="flex-1">
                        <p className="text-indigo-400 text-sm uppercase tracking-wider mb-3 font-medium">
                          Overview
                        </p>
                      ...
                      <div className="lg:w-80 flex flex-col gap-4">
                        ...
                        <button
                          onClick={() =>
                            router.push(`/pages/Player/${modalPost.id}`)
                          }
                        ...
                        <div className="flex justify-between items-center mt-4 bg-white/5 rounded-xl p-2">
                          <button className="group flex-1 flex items-center justify-center gap-2 py-3 rounded-lg hover:bg-white/10 transition-colors">
                            <div className="relative">
                              ...
                              <span className="absolute -top-3 -right-3 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center bg-indigo-600 text-white text-xs w-5 h-5 rounded-full">
                                +1
                              </span>
                            </div>
      ...
      {isLoading ? (
        ...
        <FeaturedContent post={singlePost} onPlay={handlePlayFeatured} />
      )}
