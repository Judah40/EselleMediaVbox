...
const NewsLiveCard: React.FC<NetflixCardProps> = ({ movie }) => {
        ...
        <div className="w-64 rounded-md overflow-hidden shadow-lg">
          ...
          <div className="p-4 gap-1">
            ...
            <p>
              ...
              <span> Maada Bio Elected</span>
            </p>
            <div className="px-2 py-1 rounded-full items-center gap-2 border border-red-500 bg-white inline-flex ">
