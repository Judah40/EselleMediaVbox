...
const MobileSearchModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden">
      ...
      {/* Modal Content */}
      <div className="relative bg-gradient-to-b from-gray-900 to-black border-b border-white/10 p-4">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 flex items-center bg-white/10 rounded-full border border-white/20 focus-within:border-[#1ABC9C] transition-all duration-200">
            ...
            <input
              ...
              className="flex-1 bg-transparent text-white px-4 py-3 focus:outline-none placeholder-gray-400 text-base"
            />
            {searchQuery && (
              <>
                <button
                  onClick={() => setSearchQuery("")}
                  className="p-2 hover:bg-white/10 rounded-full mr-1 transition-colors"
                ...
                <button
                  ...
                  aria-label="Search"
                >
                  <ArrowRight className="h-4 w-4 text-[#1ABC9C]" />
                </button>
              </>
            )}
          </div>
