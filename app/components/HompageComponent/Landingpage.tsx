    ...
    <div className="relative w-full h-[600px] overflow-hidden">
      ...
      <div className="relative h-full z-10 flex flex-col justify-center pb-16 px-8 ">
        ...
        <div className="max-w-2xl space-y-[16px]">
          ...
          <div className="relative spac-y-[16px]">
          ...
          <div className="flex flex-wrap items-center gap-4 md:gap-6">
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-yellow-400/20 rounded-lg transition-opacity duration-300 ${
            ...
            <button
              ...
              onMouseEnter={() => setIsHovered(true)}
              onMouseLeave={() => setIsHovered(false)}
              className="group flex items-center gap-3 bg-black/40 backdrop-blur-sm hover:bg-black/60 px-6 py-3 rounded-lg transition-all duration-300 shadow-lg"
            >
